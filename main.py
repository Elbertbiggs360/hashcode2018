...
def main():
    readWrite = ReadWrite()
    rides = readWrite.read_file("./resources/b_should_be_easy.in")
    ...
    for ride in rides:
        print (start_distance(ride.ride_start, initial_vehicle_position))


def start_distance(ride_position, vehicle_position):
